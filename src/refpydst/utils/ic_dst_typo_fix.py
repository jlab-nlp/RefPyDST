"""
Normalization and typo-fix functions copied exactly from YushiHu/IC-DST (utils/typo_fix.py). Reported ablation
comparisons to our model use DataOntologyNormalizer (i.e the same normalization). We include this for comparison.
