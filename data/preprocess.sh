...
# MultiWOZ 2.4 10% dev set for few-shot development
python sample.py --input_fn mwz2.4/dev_dials.json --target_fn mw24_10p_dev.json --ratio 0.1 --seed 88

# MultiWOZ 2.4 20% dev set for ablation evaluations
python sample.py --input_fn mwz2.4/dev_dials.json --target_fn mw24_20p_dev.json --ratio 0.2 --seed 42
...
# create a dummy 0% training set
echo "[]" > mw21_0p_train.json